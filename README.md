...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/steep-tree-a54d
```

A live public deployment of this template is available at [https://steep-tree-a54d.templates.workers.dev](https://steep-tree-a54d.templates.workers.dev)
